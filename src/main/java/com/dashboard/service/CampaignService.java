...
public interface CampaignService {
	...
	String addCampaign(String campaign_name, String campaign_desc, String campaign_start_date, String campaign_end_date,
			String json, int userid);

	String updateCampaign(int cid, String campaign_name, String campaign_desc, String campaign_start_date,
