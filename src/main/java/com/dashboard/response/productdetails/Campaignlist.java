...
public class Campaignlist {
	...
	public String toString() {
		return "Campaignlist [cid=" + cid + ", campaignName=" + campaignName + ", campaignDesc=" + campaignDesc
				+ ", campaignStartDate=" + campaignStartDate + ", campaignEndDate=" + campaignEndDate + ", json=" + json
				+ "]";
	}
